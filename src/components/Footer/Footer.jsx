  ...
  return (
   <section className='bg-black'>
     <div className='flex flex-col gap-36   items-center justify-center '>
      ...
      <div className='flex flex-grow items-center justify-betwen gap-64 py-4'>
        ...
        <h4 className='text-gray-400  flex'>2024 Crafto is Powered by <span><u>ThemeZaa</u></span></h4>
      </div>
      </div>
     </div>
   </section>
