    ...
    <section className='bg-gray-50 opacity-95'>
      <div className='container w-full space-y-10 gap-18 items-center  justify-center py-28 '>
        ...
        <div className='flex gap-8 p-8 '>
          <div className='flex flex-col py-8 rounded-md bg-white/50  shadow-xl items-center justify-center'>
            <button className='items-center px-1 w-36 py-1  my-4 rounded-2xl bg-white font-bold text-sm border-black/50 border-2'>STANDARD</button>
            <h1 className='text-5xl my-4 font-semibold'>
              <span className='text-xl font-bold align-super'>$</span>250
            </h1>
            <h4 className='text-center px-24 '>All the basic for businesses that are just getting started.</h4>
            <button className="text-white items-center w-52 bg-black px-3 py-4 mt-4 text-sm font-bold rounded-md shadow-sm">
              Choose package
            </button>
          ...
          <div className='flex flex-col rounded-md bg-white/50  shadow-xl items-center justify-center'>
            <button className='items-center px-1 w-36 py-1  my-4 rounded-2xl bg-white font-bold text-sm border-black/50 border-2'>STANDARD</button>
            <h1 className='text-5xl my-4 font-semibold'>
              <span className='text-xl font-bold align-super'>$</span>642
            </h1>
            <h4 className='text-center px-24 '>All the basic for businesses that are just getting started.</h4>
            <button className="text-white items-center w-52 bg-black px-3 py-4 mt-4 text-sm font-bold rounded-md shadow-sm">
              Choose package
